...
import { ArrowLeft } from "lucide-react";
        ...
        export const CarAccident = ({ onBack }) => {
            return (
                <>
                <style>{`
                    * { box-sizing: border-box; }
                    ...
                    .caracci-back-button:hover { background-color: #f3f4f6; }
        
                    .caracci-header-info { display:flex; flex-direction:column; justify-content:center; }
                    .caracci-header-info h1 { font-size:1.05rem; margin:0; color:#111827; }
                    .caracci-header-subtitle { margin:0; font-size:0.85rem; color:#6b7280; }
                    ...
                    .emergency-caracci{
                        ...
                        border:1px solid #e5ebbe;
                        border-radius:12px;
                        padding:2rem;
                        margin-bottom:1.5rem;
                    }
        
                    .emergency-caracci h2 { color:#0c5460; margin:0 0 0.75rem 0; }
                    .emergency-caracci p { color:#0c5460; font-size:1rem; margin:0; }
                    ...
                    @media (max-width: 1024px) {
                        .caracci-emergency-container{ padding:1.5rem; }
                        .emergency-caracci, .emr-types, .immediate-actions, .emr-call, .emr-tools{ padding:1.25rem; }
                    }
        
                    @media (max-width: 768px) {
                        .caracci-header { padding:0.75rem 1rem; }
                        .caracci-header-info h1 { font-size:1rem; }
                        .caracci-header-subtitle { font-size:0.78rem; }
        
                        .full-width-page { padding:1rem 0; }
                        .caracci-emergency-container { padding:1rem; max-width:100%; }
        
                        .emergency-caracci, .emr-types, .immediate-actions, .emr-call, .emr-tools{ padding:1rem; border-radius:8px; }
                        .emergency-caracci h2, .emr-types h3, .immediate-actions h3, .emr-call h3, .emr-tools h3{ font-size:1.05rem; }
                    ...
                    @media (max-width: 480px) {
                        .caracci-header { padding:0.5rem 0.75rem; gap:0.5rem; }
                        .caracci-header-info h1 { font-size:0.95rem; }
                        .caracci-header-subtitle { font-size:0.72rem; }
        
                        .caracci-emergency-container { padding:0.75rem; }
                        .emergency-caracci, .emr-types, .immediate-actions, .emr-call, .emr-tools{ padding:0.75rem; margin-bottom:0.9rem; }
                ...
                <div className="full-width-page">
                    <div className="caracci-emergency-container">
                        ...
                        <div className="emr-types">
                            <h3>Types of Police Emergencies</h3>
                            <ul>
