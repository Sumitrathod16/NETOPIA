...
export const PoliceEmer = ({ onBack }) => {
    return (
        <>
        <style>{`
            * { box-sizing: border-box; }
            ...
            .police-back-button:hover { background-color: #f3f4f6; }

            .police-header-info { display:flex; flex-direction:column; justify-content:center; }
            .police-header-info h1 { font-size:1.05rem; margin:0; color:#111827; }
            .police-header-subtitle { margin:0; font-size:0.85rem; color:#6b7280; }
            ...
            .emergency-police h2 { color:#0c5460; margin:0 0 0.75rem 0; }
            .emergency-police p { color:#0c5460; font-size:1rem; margin:0; }
            ...
            @media (max-width: 1024px) {
                .police-emergency-container{ padding:1.5rem; }
                .emergency-police, .emr-types, .immediate-actions, .emr-call, .emr-tools{ padding:1.25rem; }
            }

            @media (max-width: 768px) {
                .police-header { padding:0.75rem 1rem; }
                .police-header-info h1 { font-size:1rem; }
                .police-header-subtitle { font-size:0.78rem; }

                .full-width-page { padding:1rem 0; }
                .police-emergency-container { padding:1rem; max-width:100%; }

                .emergency-police, .emr-types, .immediate-actions, .emr-call, .emr-tools{ padding:1rem; border-radius:8px; }
                .emergency-police h2, .emr-types h3, .immediate-actions h3, .emr-call h3, .emr-tools h3{ font-size:1.05rem; }
            ...
            @media (max-width: 480px) {
                .police-header { padding:0.5rem 0.75rem; gap:0.5rem; }
                .police-header-info h1 { font-size:0.95rem; }
                .police-header-subtitle { font-size:0.72rem; }
